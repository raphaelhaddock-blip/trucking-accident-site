...
export const metadata: Metadata = {
  ...
  description: 'Learn about 18-Wheeler Accident Lawyers, a legal referral service connecting truck accident victims with experienced attorneys nationwide.',
  alternates: {
    canonical: '/about',
  },
};
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            18-Wheeler Accident Lawyers exists for one purpose: to help victims of
