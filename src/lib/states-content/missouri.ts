...
Missouri follows pure comparative negligence for personal injury cases. You can recover damages even if you are 99% at fault, though your recovery is reduced by your percentage of fault. The state has a 5 years statute of limitations for personal injury claims, meaning you must file suit within 5 years of the accident. These filing time limits depend on the type of claim and the facts.
  ...
  faqs: [
    {
      ...
      answer: 'Missouri has a 5 years statute of limitations for personal injury claims and 3 years for wrongful death claims from truck accidents. This means the filing deadline generally falls within 5 years of the accident date for personal injury or 3 years of the death for wrongful death. These filing time limits depend on the type of claim and the facts. Property damage claims have a 5 years deadline. It is important to contact an attorney promptly after any serious truck accident to ensure your rights are protected and evidence is preserved.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes. If a truck accident occurs in Missouri, Missouri courts generally have jurisdiction over the case regardless of where the trucking company is headquartered. The company, by operating on Missouri highways, subjects itself to Missouri jurisdiction. A truck claim may be brought in Missouri state court or in federal court (the Eastern District of Missouri / Western District of Missouri). Federal court may be appropriate when the case involves parties from different states and the amount in controversy exceeds $75,000. Your attorney can advise on the court process for your specific situation based on factors including the defendant\'s location, available evidence, and local court practices.'
    },
    {
