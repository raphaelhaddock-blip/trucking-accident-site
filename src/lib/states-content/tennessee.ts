...
Tennessee follows modified comparative negligence with a 50% bar for personal injury cases. You can recover damages if you are 49% or less at fault, but recovery is barred if you are 50% or more at fault. The state has a 1 year statute of limitations for personal injury claims, meaning you must file suit within 1 year of the accident. These filing time limits depend on the type of claim and the facts.
  ...
  faqs: [
    {
      ...
      answer: 'Tennessee has a 1 year statute of limitations for personal injury claims and 1 year for wrongful death claims from truck accidents. This means the filing deadline generally falls within 1 year of the accident date for personal injury or 1 year of the death for wrongful death. These filing time limits depend on the type of claim and the facts. Property damage claims have a 3 years deadline. It is important to contact an attorney promptly after any serious truck accident to ensure your rights are protected and evidence is preserved.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes. If a truck accident occurs in Tennessee, Tennessee courts generally have jurisdiction over the case regardless of where the trucking company is headquartered. The company, by operating on Tennessee highways, subjects itself to Tennessee jurisdiction. A truck claim may be brought in Tennessee state court or in federal court (the Eastern/Middle/Western District of Tennessee). Federal court may be appropriate when the case involves parties from different states and the amount in controversy exceeds $75,000. Your attorney can advise on the court process for your specific situation based on factors including the defendant\'s location, available evidence, and local court practices.'
    },
    {
