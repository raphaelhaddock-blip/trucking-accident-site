...
export const CLARKSVILLE_CONTENT: CityContent = {
  ...
  dangerousRoads: [
      {
          "name": "I-40",
          "description": "Major trucking corridor through Clarksville. oil field hauling on this route increases accident risk.",
          "milesInCity": 22
      },
      {
          "name": "I-30",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "26%",
          "localFactor": "I-40 traffic through Clarksville contributes to this type. High-volume Texas interstates and sudden traffic slowdowns"
      },
      {
      ...
      },
      {
          ...
          "percentage": "21%",
          "localFactor": "I-40 traffic through Clarksville contributes to this type. Sudden thunderstorms and flash flooding create hazards"
      },
      {
  ...
  truckingIndustry: `Clarksville's location along I-40 means steady commercial truck traffic despite the city's size. oil field hauling keeps 18-wheelers moving through day and night.

Commercial trucks in Clarksville operate under tight schedules that can pressure drivers to violate federal hours-of-service regulations. Combined with extreme heat, this creates serious accident risks for local residents.`,

  legalInfo: `Truck accident claims in Clarksville are governed by Arkansas state law and federal FMCSA regulations. Key legal considerations include:
...
Our Clarksville truck accident attorneys understand both Arkansas law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,
