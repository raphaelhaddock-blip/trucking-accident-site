...
export const KNOXVILLE_CONTENT: CityContent = {
  ...
  dangerousRoads: [
      {
          "name": "I-80",
          "description": "Major trucking corridor through Knoxville. Chicago hub volume on this route increases accident risk.",
          "milesInCity": 12
      },
      {
          "name": "I-35",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "29%",
          "localFactor": "I-80 traffic through Knoxville contributes to this type. Chicago metro congestion and I-80 traffic cause rear-ends"
      },
      {
          "type": "Jackknife Accidents",
          "percentage": "23%",
          "localFactor": "I-80 traffic through Knoxville contributes to this type. Winter ice storms and black ice lead to jackknife crashes"
      },
      {
  ...
  truckingIndustry: `Knoxville's location along I-80 means steady commercial truck traffic despite the city's size. Chicago hub volume keeps 18-wheelers moving through day and night.

Commercial trucks in Knoxville operate under tight schedules that can pressure drivers to violate federal hours-of-service regulations. Combined with ice storms, this creates serious accident risks for local residents.`,

  legalInfo: `Truck accident claims in Knoxville are governed by Iowa state law and federal FMCSA regulations. Key legal considerations include:
...
Our Knoxville truck accident attorneys understand both Iowa law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,

  faqs: [
      {
          "question": "What's the average settlement for Knoxville truck crashes?",
          "answer": "Truck accident settlements in rural areas like Knoxville can be substantial despite lower population density. The Midwest region's unique trucking hazards—ice storms and blizzards—often contribute to severe accidents. While average settlements are difficult to calculate, serious truck accident cases regularly result in six and seven-figure recoveries."
      },
      {
      ...
      },
      {
          ...
          "answer": "I-80 near Knoxville sees high truck accident rates due to heavy commercial traffic volume combined with ice storms and blizzards. The corridor carries significant freight between major distribution points. Driver fatigue on long hauls, congestion-related rear-end collisions, and weather-related incidents all contribute to accident frequency in this area."
      },
      {
