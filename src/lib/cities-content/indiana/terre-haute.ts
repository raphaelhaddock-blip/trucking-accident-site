...
export const TERRE_HAUTE_CONTENT: CityContent = {
  ...
  metaDescription: 'Top-rated Terre Haute truck accident attorneys for the Midwest area. No fee unless we win your case.',
  h1: 'Terre Haute Truck Accident Lawyers',

  heroText: `Terre Haute's 58,389 residents live alongside busy trucking corridors in Indiana. Even with fewer resources than larger cities, we recorded 1 fatal truck accidents in 2022. Our team provides experienced legal representation for victims of 18-wheeler crashes.`,
  ...
  dangerousRoads: [
      {
          "name": "I-65",
          "description": "Major trucking corridor through Terre Haute. Chicago hub volume on this route increases accident risk.",
          "milesInCity": 6
      },
      {
          "name": "I-70",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "31%",
          "localFactor": "I-65 traffic through Terre Haute contributes to this type. Chicago metro congestion and I-80 traffic cause rear-ends"
      },
      {
          "type": "Jackknife Accidents",
          "percentage": "20%",
          "localFactor": "I-65 traffic through Terre Haute contributes to this type. Winter ice storms and black ice lead to jackknife crashes"
      },
      {
  ...
  truckingIndustry: `Terre Haute's location along I-65 means steady commercial truck traffic despite the city's size. Chicago hub volume keeps 18-wheelers moving through day and night.

Commercial trucks in Terre Haute operate under tight schedules that can pressure drivers to violate federal hours-of-service regulations. Combined with ice storms, this creates serious accident risks for local residents.`,

  legalInfo: `Truck accident claims in Terre Haute are governed by Indiana state law and federal FMCSA regulations. Key legal considerations include:
...
Our Terre Haute truck accident attorneys understand both Indiana law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,

  faqs: [
      {
          "question": "What's the average settlement for Terre Haute truck crashes?",
          "answer": "Truck accident settlements in rural areas like Terre Haute can be substantial despite lower population density. The Midwest region's unique trucking hazards—ice storms and blizzards—often contribute to severe accidents. While average settlements are difficult to calculate, serious truck accident cases regularly result in six and seven-figure recoveries."
      },
      {
      ...
      {
          "question": "Can I still recover damages if I was partially at fault for a Terre Haute truck accident?",
