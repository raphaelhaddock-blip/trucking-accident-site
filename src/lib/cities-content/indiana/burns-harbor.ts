...
export const BURNS_HARBOR_CONTENT: CityContent = {
  ...
  metaDescription: 'Burns Harbor semi-truck crash lawyers. Dedicated to helping Indiana accident victims recover maximum compensation.',
  ...
  dangerousRoads: [
      {
          "name": "I-65",
          "description": "Major trucking corridor through Burns Harbor. Chicago hub volume on this route increases accident risk.",
          "milesInCity": 17
      },
      {
          "name": "I-70",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "26%",
          "localFactor": "I-65 traffic through Burns Harbor contributes to this type. Chicago metro congestion and I-80 traffic cause rear-ends"
      },
      {
          "type": "Jackknife Accidents",
          "percentage": "22%",
          "localFactor": "I-65 traffic through Burns Harbor contributes to this type. Winter ice storms and black ice lead to jackknife crashes"
      },
      {
  ...
  truckingIndustry: `Burns Harbor's location along I-65 means steady commercial truck traffic despite the city's size. Chicago hub volume keeps 18-wheelers moving through day and night.

Commercial trucks in Burns Harbor operate under tight schedules that can pressure drivers to violate federal hours-of-service regulations. Combined with ice storms, this creates serious accident risks for local residents.`,

  legalInfo: `Truck accident claims in Burns Harbor are governed by Indiana state law and federal FMCSA regulations. Key legal considerations include:
...
Our Burns Harbor truck accident attorneys understand both Indiana law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,

  faqs: [
      {
          "question": "What's the average settlement for Burns Harbor truck crashes?",
          "answer": "Truck accident settlements in rural areas like Burns Harbor can be substantial despite lower population density. The Midwest region's unique trucking hazards—ice storms and blizzards—often contribute to severe accidents. While average settlements are difficult to calculate, serious truck accident cases regularly result in six and seven-figure recoveries."
      },
      {
