...
export const ROLLA_CONTENT: CityContent = {
  ...
  dangerousRoads: [
      {
          "name": "I-70",
          "description": "Major trucking corridor through Rolla. Chicago hub volume on this route increases accident risk.",
          "milesInCity": 14
      },
      {
          "name": "I-44",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "27%",
          "localFactor": "I-70 traffic through Rolla contributes to this type. Chicago metro congestion and I-80 traffic cause rear-ends"
      },
      {
          "type": "Jackknife Accidents",
          "percentage": "19%",
          "localFactor": "I-70 traffic through Rolla contributes to this type. Winter ice storms and black ice lead to jackknife crashes"
      },
      {
  ...
  truckingIndustry: `Rolla's location along I-70 means steady commercial truck traffic despite the city's size. Chicago hub volume keeps 18-wheelers moving through day and night.

Commercial trucks in Rolla operate under tight schedules that can pressure drivers to violate federal hours-of-service regulations. Combined with ice storms, this creates serious accident risks for local residents.`,

  legalInfo: `Truck accident claims in Rolla are governed by Missouri state law and federal FMCSA regulations. Key legal considerations include:
...
Our Rolla truck accident attorneys understand both Missouri law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,

  faqs: [
      {
          "question": "What's the average settlement for Rolla truck crashes?",
          "answer": "Truck accident settlements in rural areas like Rolla can be substantial despite lower population density. The Midwest region's unique trucking hazards—ice storms and blizzards—often contribute to severe accidents. While average settlements are difficult to calculate, serious truck accident cases regularly result in six and seven-figure recoveries."
      },
      {
      ...
      {
          "question": "Can I still recover damages if I was partially at fault for a Rolla truck accident?",
      ...
      {
          "question": "Why do I need a truck accident lawyer in Rolla?",
