...
export const PORTLAND_CONTENT: CityContent = {
  ...
  metaDescription: 'Portland semi-truck crash lawyers. Dedicated to helping Maine accident victims recover maximum compensation.',
  h1: 'Portland Truck Accident Lawyers',

  heroText: `Portland's 25,000 residents live alongside busy trucking corridors in Maine. Even with fewer resources than larger cities, we recorded 1 fatal truck accidents in 2022. Our team provides experienced legal representation for victims of 18-wheeler crashes.`,
  ...
  dangerousRoads: [
      {
          "name": "I-95",
          "description": "Major trucking corridor through Portland. urban congestion on this route increases accident risk.",
          "milesInCity": 11
      },
      {
          "name": "I-295",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "32%",
          "localFactor": "I-95 traffic through Portland contributes to this type. Dense urban traffic and frequent congestion in metro areas lead to rear-end collisions"
      },
      {
          "type": "Jackknife Accidents",
          "percentage": "16%",
          "localFactor": "I-95 traffic through Portland contributes to this type. Winter ice and snow on narrow highways cause jackknife incidents"
      },
      {
  ...
  truckingIndustry: `Portland's location along I-95 means steady commercial truck traffic despite the city's size. urban congestion keeps 18-wheelers moving through day and night.

Commercial trucks in Portland operate under tight schedules that can pressure drivers to violate federal hours-of-service regulations. Combined with winter ice, this creates serious accident risks for local residents.`,
...
Our Portland truck accident attorneys understand both Maine law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,

  faqs: [
      {
          "question": "What's the average settlement for Portland truck crashes?",
          "answer": "Truck accident settlements in rural areas like Portland can be substantial despite lower population density. The Northeast region's unique trucking hazards—winter ice and black ice—often contribute to severe accidents. While average settlements are difficult to calculate, serious truck accident cases regularly result in six and seven-figure recoveries."
      },
      {
