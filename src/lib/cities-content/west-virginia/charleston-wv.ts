...
export const CHARLESTON_WV_CONTENT: CityContent = {
  slug: 'charleston-wv',
  name: 'Charleston',
  ...
  metaDescription: 'Experienced Charleston truck accident lawyers. 10 fatal crashes in 2022. Free consultation for 18-wheeler accident victims. No fee unless you win.',
  h1: 'Charleston Truck Accident Lawyers',

  heroText: `Charleston is home to 48,864 residents and sits along major commercial trucking routes in West Virginia. In 2022, the Charleston area recorded 10 fatal truck crashes according to NHTSA FARS data. If you or a loved one was injured in a truck accident, our experienced attorneys fight for maximum compensation against trucking companies and their insurers.`,
  ...
  accidentStats: {
    ...
    comparisonToState: '21% of West Virginia truck fatalities',
...
Our Charleston truck accident attorneys understand both West Virginia law and federal trucking regulations. We investigate accidents thoroughly, preserve evidence, and build strong cases for maximum compensation.`,
...
export default CHARLESTON_WV_CONTENT;
