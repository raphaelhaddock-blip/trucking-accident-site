...
export const GREENWOOD_CONTENT: CityContent = {
  ...
  dangerousRoads: [
      {
          "name": "I-10",
          "description": "Major trucking corridor through Greenwood. port traffic on this route increases accident risk.",
          "milesInCity": 7
      },
      {
          "name": "I-20",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "25%",
          "localFactor": "I-10 traffic through Greenwood contributes to this type. Port traffic congestion leads to rear-end collisions"
      },
      {
      ...
      },
      {
          ...
          "percentage": "21%",
          "localFactor": "I-10 traffic through Greenwood contributes to this type. Wet roads and hydroplaning cause jackknife incidents"
      },
      {
  ...
  truckingIndustry: `Greenwood's location along I-10 means steady commercial truck traffic despite the city's size. port traffic keeps 18-wheelers moving through day and night.

Commercial trucks in Greenwood operate under tight schedules that can pressure drivers to violate federal hours-of-service regulations. Combined with hurricanes, this creates serious accident risks for local residents.`,

  legalInfo: `Truck accident claims in Greenwood are governed by Louisiana state law and federal FMCSA regulations. Key legal considerations include:
...
Our Greenwood truck accident attorneys understand both Louisiana law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,
  ...
  faqs: [
      ...
      {
          "question": "What evidence should I gather after a truck accident in Greenwood?",
          "answer": "After a truck accident in Greenwood, gather as much evidence as possible: photos of all vehicles and the scene, the truck's DOT number and company information, driver information, witness contact details, and the police report number. Seek immediate medical attention and keep all medical records. Critical truck evidence like electronic logging device data, dash cam footage, and inspection records must be preserved quickly—your attorney can send a spoliation letter requiring the trucking company to preserve this evidence."
      },
      {
          "question": "Why do I need a truck accident lawyer in Greenwood?",
