...
export const IRVING_CONTENT: CityContent = {
  ...
  dangerousRoads: [
      {
          "name": "I-10",
          "description": "Major trucking corridor through Irving. oil field hauling on this route increases accident risk.",
          "milesInCity": 12
      },
      {
          "name": "I-35",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "28%",
          "localFactor": "I-10 traffic through Irving contributes to this type. High-volume Texas interstates and sudden traffic slowdowns"
      },
      {
      ...
      },
      {
          ...
          "percentage": "19%",
          "localFactor": "I-10 traffic through Irving contributes to this type. Sudden thunderstorms and flash flooding create hazards"
      },
      {
  ...
  truckingIndustry: `Commercial trucking is vital to Irving's economy, connecting local businesses to oil field hauling. I-10 through the city sees heavy truck volumes year-round.
...
Our Irving truck accident attorneys understand both Texas law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,

  faqs: [
      {
          "question": "What's the average settlement for Irving truck crashes?",
          "answer": "Settlement amounts for Irving truck accidents vary based on injury severity, liability clarity, and insurance coverage. Serious injuries typically result in settlements ranging from $250,000 to over $1 million. Consult with a local attorney who understands Texas law to evaluate your potential case value."
      },
      {
