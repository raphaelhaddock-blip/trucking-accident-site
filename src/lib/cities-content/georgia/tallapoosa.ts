...
export const TALLAPOOSA_CONTENT: CityContent = {
  ...
  dangerousRoads: [
      {
          "name": "I-75",
          "description": "Major trucking corridor through Tallapoosa. distribution hub volume on this route increases accident risk.",
          "milesInCity": 18
      },
      {
          "name": "I-85",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "30%",
          "localFactor": "I-75 traffic through Tallapoosa contributes to this type. Heavy I-85 and I-95 traffic creates stop-and-go conditions"
      },
      {
      ...
      },
      {
          ...
          "percentage": "14%",
          "localFactor": "I-75 traffic through Tallapoosa contributes to this type. Hydroplaning during heavy rain causes jackknife incidents"
      },
      {
  ...
  truckingIndustry: `Tallapoosa's location along I-75 means steady commercial truck traffic despite the city's size. distribution hub volume keeps 18-wheelers moving through day and night.

Commercial trucks in Tallapoosa operate under tight schedules that can pressure drivers to violate federal hours-of-service regulations. Combined with summer thunderstorms, this creates serious accident risks for local residents.`,

  legalInfo: `Truck accident claims in Tallapoosa are governed by Georgia state law and federal FMCSA regulations. Key legal considerations include:
...
Our Tallapoosa truck accident attorneys understand both Georgia law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,

  faqs: [
      {
          "question": "What's the average settlement for Tallapoosa truck crashes?",
          "answer": "Truck accident settlements in rural areas like Tallapoosa can be substantial despite lower population density. The Southeast region's unique trucking hazards—summer thunderstorms and hurricanes—often contribute to severe accidents. While average settlements are difficult to calculate, serious truck accident cases regularly result in six and seven-figure recoveries."
      },
      {
      ...
      {
          "question": "Can I still recover damages if I was partially at fault for a Tallapoosa truck accident?",
