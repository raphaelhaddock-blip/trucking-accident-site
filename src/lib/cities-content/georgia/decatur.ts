...
export const DECATUR_CONTENT: CityContent = {
  ...
  metaDescription: 'Decatur, Georgia 18-wheeler accident attorneys. 1 fatal truck crashes recorded. Free consultation.',
  ...
  commonAccidents: [
      {
          ...
          "percentage": "30%",
          "localFactor": "I-75 traffic through Decatur contributes to this type. Heavy I-85 and I-95 traffic creates stop-and-go conditions"
      },
      {
      ...
      },
      {
          ...
          "percentage": "18%",
          "localFactor": "I-75 traffic through Decatur contributes to this type. Hydroplaning during heavy rain causes jackknife incidents"
      },
      {
  ...
  truckingIndustry: `Though smaller than major metros, Decatur sits on key trucking routes in Georgia. distribution hub volume brings commercial vehicles past residential and commercial areas.
...
Georgia commercial trucks carry goods vital to the economy, but this heavy traffic comes with risks. summer thunderstorms can make already-dangerous truck encounters even more hazardous for passenger vehicles.`,
  ...
  legalInfo: `Truck accident claims in Decatur are governed by Georgia state law and federal FMCSA regulations. Key legal considerations include:
...
Our Decatur truck accident attorneys understand both Georgia law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,
  ...
  faqs: [
      ...
      {
          "question": "What is the statute of limitations for truck accident cases in Decatur, Georgia?",
