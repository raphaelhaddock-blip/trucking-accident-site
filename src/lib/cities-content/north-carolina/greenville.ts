...
export const GREENVILLE_CONTENT: CityContent = {
  ...
  metaDescription: 'Greenville semi-truck crash lawyers. Dedicated to helping North Carolina accident victims recover maximum compensation.',
  h1: 'Greenville Truck Accident Lawyers',

  heroText: `Greenville's 25,000 residents live alongside busy trucking corridors in North Carolina. Even with fewer resources than larger cities, we recorded 1 fatal truck accidents in 2022. Our team provides experienced legal representation for victims of 18-wheeler crashes.`,
...
Commercial trucks in Greenville operate under tight schedules that can pressure drivers to violate federal hours-of-service regulations. Combined with summer thunderstorms, this creates serious accident risks for local residents.`,
  ...
  legalInfo: `Truck accident claims in Greenville are governed by North Carolina state law and federal FMCSA regulations. Key legal considerations include:
...
Our Greenville truck accident attorneys understand both North Carolina law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,
  ...
  faqs: [
      ...
      {
          "question": "What evidence should I gather after a truck accident in Greenville?",
          "answer": "After a truck accident in Greenville, gather as much evidence as possible: photos of all vehicles and the scene, the truck's DOT number and company information, driver information, witness contact details, and the police report number. Seek immediate medical attention and keep all medical records. Critical truck evidence like electronic logging device data, dash cam footage, and inspection records must be preserved quickly—your attorney can send a spoliation letter requiring the trucking company to preserve this evidence."
      },
      {
