...
export const AUBURN_CONTENT: CityContent = {
  ...
  metaDescription: 'Washington truck crash lawyers in Auburn. Experienced with rain-related accidents.',
  h1: 'Auburn Truck Accident Lawyers',

  heroText: `In Auburn, Washington, a community of 25,000, commercial trucks pass through daily on major routes. 1 fatal truck crashes occurred in 2022. Our attorneys fight to ensure truck accident victims receive fair compensation regardless of the size of their community.`,
  ...
  dangerousRoads: [
      {
          "name": "I-5",
          "description": "Major trucking corridor through Auburn. port traffic on this route increases accident risk.",
          "milesInCity": 22
      },
      {
          "name": "I-90",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "31%",
          "localFactor": "I-5 traffic through Auburn contributes to this type. LA, Bay Auburn, and Seattle metro congestion"
      },
      {
      ...
      },
      {
          ...
          "percentage": "19%",
          "localFactor": "I-5 traffic through Auburn contributes to this type. Rain on oil-slicked roads and mountain routes"
      },
      {
  ...
  truckingIndustry: `Truck traffic in Auburn stems largely from port traffic passing through on I-5. Local residents share roads with these large commercial vehicles.
...
The Washington trucking industry employs thousands of drivers who transport goods across the state. However, factors including rain, fog create hazardous conditions. When tired or negligent drivers operate 80,000-pound vehicles in these conditions, catastrophic accidents result.`,
  ...
  legalInfo: `Truck accident claims in Auburn are governed by Washington state law and federal FMCSA regulations. Key legal considerations include:
...
Our Auburn truck accident attorneys understand both Washington law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,
  ...
  faqs: [
      ...
      {
          "question": "What evidence should I gather after a truck accident in Auburn?",
          "answer": "After a truck accident in Auburn, gather as much evidence as possible: photos of all vehicles and the scene, the truck's DOT number and company information, driver information, witness contact details, and the police report number. Seek immediate medical attention and keep all medical records. Critical truck evidence like electronic logging device data, dash cam footage, and inspection records must be preserved quickly—your attorney can send a spoliation letter requiring the trucking company to preserve this evidence."
      },
      {
          "question": "What are common injuries in Auburn truck accidents?",
          "answer": "Truck accidents in Auburn often cause severe injuries due to the massive size difference between commercial trucks and passenger vehicles. Common injuries include traumatic brain injuries, spinal cord damage, multiple fractures, internal organ damage, burns, and wrongful death. Even 'minor' truck accidents frequently cause long-term injuries requiring extensive medical treatment. The Pacific region's rain and fog contribute to particularly severe accident types."
      }
  ],
