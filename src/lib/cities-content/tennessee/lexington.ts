...
export const LEXINGTON_CONTENT: CityContent = {
  ...
  metaDescription: 'Lexington, Tennessee 18-wheeler accident attorneys. 1 fatal truck crashes recorded. Free consultation.',
  h1: 'Lexington Truck Accident Lawyers',

  heroText: `Despite its population of 25,000, Lexington sees significant truck traffic due to its location on key Tennessee shipping routes. 1 fatal truck crashes were recorded in 2022. Our attorneys bring big-city expertise to help Lexington accident victims.`,
  ...
  commonAccidents: [
      {
          ...
          "percentage": "31%",
          "localFactor": "I-40 traffic through Lexington contributes to this type. Heavy I-85 and I-95 traffic creates stop-and-go conditions"
      },
      {
      ...
      },
      {
          ...
          "percentage": "16%",
          "localFactor": "I-40 traffic through Lexington contributes to this type. Hydroplaning during heavy rain causes jackknife incidents"
      },
      {
  ...
  truckingIndustry: `Though smaller than major metros, Lexington sits on key trucking routes in Tennessee. distribution hub volume brings commercial vehicles past residential and commercial areas.
...
Tennessee commercial trucks carry goods vital to the economy, but this heavy traffic comes with risks. summer thunderstorms can make already-dangerous truck encounters even more hazardous for passenger vehicles.`,
  ...
  legalInfo: `Truck accident claims in Lexington are governed by Tennessee state law and federal FMCSA regulations. Key legal considerations include:
...
Our Lexington truck accident attorneys understand both Tennessee law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,
  ...
  faqs: [
      ...
      {
          "question": "What is the statute of limitations for truck accident cases in Lexington, Tennessee?",
      ...
      {
          "question": "How much does a truck accident lawyer in Lexington cost?",
          "answer": "Most truck accident lawyers in Lexington work on a contingency fee basis—you pay nothing upfront and no attorney fees unless you win. The attorney fee is typically a percentage of your recovery, usually 33-40% depending on whether the case settles or goes to trial. This arrangement allows accident victims to access quality legal representation regardless of their financial situation. You should also understand what case costs are covered."
      },
      {
          "question": "What are common injuries in Lexington truck accidents?",
          "answer": "Truck accidents in Lexington often cause severe injuries due to the massive size difference between commercial trucks and passenger vehicles. Common injuries include traumatic brain injuries, spinal cord damage, multiple fractures, internal organ damage, burns, and wrongful death. Even 'minor' truck accidents frequently cause long-term injuries requiring extensive medical treatment. The Southeast region's summer thunderstorms and hurricanes contribute to particularly severe accident types."
      },
      {
