...
export const MADISON_CONTENT: CityContent = {
  ...
  metaDescription: 'Madison, Tennessee 18-wheeler accident attorneys. 1 fatal truck crashes recorded. Free consultation.',
  h1: 'Madison Truck Accident Lawyers',

  heroText: `Despite its population of 25,000, Madison sees significant truck traffic due to its location on key Tennessee shipping routes. 1 fatal truck crashes were recorded in 2022. Our attorneys bring big-city expertise to help Madison accident victims. Hazards including summer thunderstorms and hurricanes increase accident risks in this region.`,
  ...
  dangerousRoads: [
      {
          "name": "I-40",
          "description": "Major trucking corridor through Madison. distribution hub volume on this route increases accident risk.",
          "milesInCity": 16
      },
      {
          "name": "I-65",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "28%",
          "localFactor": "I-40 traffic through Madison contributes to this type. Heavy I-85 and I-95 traffic creates stop-and-go conditions"
      },
      {
      ...
      },
      {
          ...
          "percentage": "18%",
          "localFactor": "I-40 traffic through Madison contributes to this type. Hydroplaning during heavy rain causes jackknife incidents"
      },
      {
  ...
  truckingIndustry: `Though smaller than major metros, Madison sits on key trucking routes in Tennessee. distribution hub volume brings commercial vehicles past residential and commercial areas.
...
Tennessee commercial trucks carry goods vital to the economy, but this heavy traffic comes with risks. summer thunderstorms can make already-dangerous truck encounters even more hazardous for passenger vehicles.`,
  ...
  legalInfo: `Truck accident claims in Madison are governed by Tennessee state law and federal FMCSA regulations. Key legal considerations include:
...
Our Madison truck accident attorneys understand both Tennessee law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,

  faqs: [
      {
          "question": "How much is a truck accident case worth in Madison?",
          "answer": "Truck accident case values in Madison depend on the severity of injuries and evidence of negligence. Despite our area's lower accident rate (1 fatal crashes in 2022), individual case values can still be substantial. Settlement amounts typically range from tens of thousands for minor injuries to millions for permanent disabilities. An experienced attorney can evaluate your specific case."
      },
      {
          "question": "What is the statute of limitations for truck accident cases in Madison, Tennessee?",
      ...
      {
          "question": "What evidence should I gather after a truck accident in Madison?",
          "answer": "After a truck accident in Madison, gather as much evidence as possible: photos of all vehicles and the scene, the truck's DOT number and company information, driver information, witness contact details, and the police report number. Seek immediate medical attention and keep all medical records. Critical truck evidence like electronic logging device data, dash cam footage, and inspection records must be preserved quickly—your attorney can send a spoliation letter requiring the trucking company to preserve this evidence."
      },
      {
          "question": "How much does a truck accident lawyer in Madison cost?",
          "answer": "Most truck accident lawyers in Madison work on a contingency fee basis—you pay nothing upfront and no attorney fees unless you win. The attorney fee is typically a percentage of your recovery, usually 33-40% depending on whether the case settles or goes to trial. This arrangement allows accident victims to access quality legal representation regardless of their financial situation. You should also understand what case costs are covered."
      },
      {
