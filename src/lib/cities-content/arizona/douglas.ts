...
export const DOUGLAS_CONTENT: CityContent = {
  ...
  metaDescription: 'Douglas semi-truck crash lawyers. Dedicated to helping Arizona accident victims recover maximum compensation.',
  h1: 'Douglas Truck Accident Lawyers',

  heroText: `Douglas's 25,000 residents live alongside busy trucking corridors in Arizona. Even with fewer resources than larger cities, we recorded 1 fatal truck accidents in 2022. Our team provides experienced legal representation for victims of 18-wheeler crashes.`,
  ...
  dangerousRoads: [
      {
          "name": "I-10",
          "description": "Major trucking corridor through Douglas. border crossing traffic on this route increases accident risk.",
          "milesInCity": 13
      },
      {
          "name": "I-40",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "24%",
          "localFactor": "I-10 traffic through Douglas contributes to this type. Phoenix and Las Vegas metro traffic congestion"
      },
      {
      ...
      },
      {
          ...
          "percentage": "18%",
          "localFactor": "I-10 traffic through Douglas contributes to this type. Sudden monsoon storms create slick roads"
      },
      {
  ...
  truckingIndustry: `Douglas's location along I-10 means steady commercial truck traffic despite the city's size. border crossing traffic keeps 18-wheelers moving through day and night.

Commercial trucks in Douglas operate under tight schedules that can pressure drivers to violate federal hours-of-service regulations. Combined with extreme heat, this creates serious accident risks for local residents.`,

  legalInfo: `Truck accident claims in Douglas are governed by Arizona state law and federal FMCSA regulations. Key legal considerations include:
...
Our Douglas truck accident attorneys understand both Arizona law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,
  ...
  faqs: [
      ...
      {
          "question": "What insurance covers truck accidents in Douglas?",
          "answer": "Multiple insurance policies may cover a Douglas truck accident: the trucking company's liability insurance (federal minimum $750,000-$5 million depending on cargo), the driver's personal insurance, your own uninsured/underinsured motorist coverage, and your health insurance or Med-Pay. An attorney will identify all available coverage sources to maximize your recovery."
      },
      {
