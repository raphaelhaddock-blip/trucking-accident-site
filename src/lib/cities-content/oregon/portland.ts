...
export const PORTLAND_CONTENT: CityContent = {
  ...
  metaDescription: 'Injured in a truck crash in Portland? 7 fatal truck accidents in 2022. Experienced attorneys serving Multnomah County, Oregon. Free consultation.',
  h1: 'Portland Truck Accident Lawyers',

  heroText: `Portland, Oregon is home to 652,503 residents and a significant commercial trucking corridor. In 2022, 7 people were killed in truck-related crashes in the Portland area according to NHTSA FARS data. The city's manufacturing and agriculture industries generate substantial truck traffic on I-5 and I-84. Dense fog creates additional hazards during November and December. Our experienced truck accident attorneys serve Multnomah County and help victims navigate complex claims against trucking companies.`,
  ...
  accidentStats: {
    ...
    comparisonToState: '7 of Oregon truck fatalities',
...
In Portland, an experienced truck accident attorney immediately sends a spoliation letter demanding the trucking company preserve all evidence. This creates legal obligations that, if violated, can result in sanctions against the carrier. Time is essential—contact a Multnomah County truck accident lawyer as soon as possible after your accident to ensure critical evidence is preserved.`,
...
Vehicle maintenance requirements mandate regular inspections and documented repairs. Pre-trip and post-trip inspection requirements ensure drivers identify and report mechanical issues. When trucking companies defer maintenance to save money, dangerous conditions develop—brake fade, tire failures, coupling device defects—that cause preventable accidents on Portland highways.`,
  ...
  dangerousRoads: [
      {
          "name": "I-5",
          "description": "I-5 through Portland carries significant commercial truck traffic as part of the national Interstate Highway System. This corridor connects Portland to major metropolitan areas and serves as a primary route for freight transportation. The combination of heavy local traffic, commercial trucks, and dense fog creates challenging driving conditions. Truck accidents on I-5 near Portland often involve high-speed traffic mixing with local vehicles and merging conflicts at on/off ramps.",
          "milesInCity": 21
      },
      {
          "name": "I-84",
          "description": "I-84 through Portland carries significant commercial truck traffic as part of the national Interstate Highway System. This corridor connects Portland to major metropolitan areas and serves as a primary route for freight transportation. The combination of heavy local traffic, commercial trucks, and dense fog creates challenging driving conditions. Truck accidents on I-84 near Portland often involve high-speed traffic mixing with local vehicles and merging conflicts at on/off ramps.",
          "milesInCity": 21
      },
      {
          "name": "I-405",
          "description": "I-405 through Portland carries significant commercial truck traffic as part of the national Interstate Highway System. This corridor connects Portland to major metropolitan areas and serves as a primary route for freight transportation. The combination of heavy local traffic, commercial trucks, and dense fog creates challenging driving conditions. Truck accidents on I-405 near Portland often involve high-speed traffic mixing with local vehicles and merging conflicts at on/off ramps.",
          "milesInCity": 25
      },
      {
          "name": "US-26",
          "description": "US-26 near Portland serves as an important regional route for commercial trucking. The road handles a mix of local traffic and through freight, with truck accidents often occurring during November and December when dense fog affects driving conditions.",
          "milesInCity": 7
      }
  ],
  ...
  commonAccidents: [
      {
          ...
          "percentage": "33%",
          "localFactor": "Heavy traffic congestion on I-5 contributes to rear-end truck crashes in Portland. The combination of high truck volumes and urban traffic patterns makes following distance violations particularly dangerous."
      },
      {
          "type": "Jackknife Accidents",
          "percentage": "23%",
          "localFactor": "Dense fog during November and December increases jackknife risk on Portland highways. When truck trailers lose traction, the resulting jackknife can block multiple lanes and cause chain-reaction collisions."
      },
      {
