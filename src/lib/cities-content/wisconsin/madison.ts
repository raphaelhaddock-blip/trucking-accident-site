...
export const MADISON_CONTENT: CityContent = {
  ...
  metaDescription: 'Madison truck accident lawyers with proven results. 1 fatal crashes in 2022. Free case evaluation.',
  h1: 'Madison Truck Accident Lawyers',

  heroText: `Madison, Wisconsin has a growing population of 269,840 and sits along major trucking corridors. In 2022, the area experienced 1 fatal truck crashes. Our truck accident attorneys understand the unique challenges of pursuing claims in mid-sized markets like Madison.`,
  ...
  dangerousRoads: [
      {
          "name": "I-94",
          "description": "Major trucking corridor through Madison. manufacturing hub volume on this route increases accident risk.",
          "milesInCity": 13
      },
      {
          "name": "I-90",
  ...
  commonAccidents: [
      {
          ...
          "percentage": "28%",
          "localFactor": "I-94 traffic through Madison contributes to this type. Manufacturing hub traffic and sudden weather changes"
      },
      {
          "type": "Jackknife Accidents",
          "percentage": "23%",
          "localFactor": "I-94 traffic through Madison contributes to this type. Lake-effect snow and ice create dangerous conditions"
      },
      {
  ...
  truckingIndustry: `Madison serves as an important waypoint for manufacturing hub volume in Wisconsin. The city's location on I-94 brings significant 18-wheeler traffic.
...
Our Madison truck accident attorneys understand both Wisconsin law and federal trucking regulations. We investigate accidents thoroughly, preserve critical evidence, and build strong cases for maximum compensation.`,
  ...
  faqs: [
      ...
      {
          "question": "What is the statute of limitations for truck accident cases in Madison, Wisconsin?",
