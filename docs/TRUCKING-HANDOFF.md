...
1. **Finish the P4 city-hub image *plan*** — the plan, not the generation. **DONE 2026-06-25:** [P4-CITY-HUB-IMAGE-PLAN.md](P4-CITY-HUB-IMAGE-PLAN.md) is now final/approval-ready — 10 cities in 2 tiers, exact per-city prompts, render target, ~$0.40–0.50 cost, pass/fail + tier gate, and a required (no-spend) `CITY_SCENE` code edit before any run. Generation still gated on Raphy's "go P4".
